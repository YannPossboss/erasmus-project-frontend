...
function RecipeTempl(props){
    ...
    if(recipeShowNumberUpdate != recipeShowNumber || SearchTextUpdate != updatedSearchText){
        ...
        axios.post('http://erasmus-recipes-backend.herokuapp.com/recipe', {recipeId: recipeShowNumber + 1, search: updatedSearchText})
        .then(response =>{
            console.log(response)
        ...
        axios.post('http://erasmus-recipes-backend.herokuapp.com/recipe', {recipeId: recipeShowNumber + 2, search: updatedSearchText})
        .then(response =>{
            console.log(response)
